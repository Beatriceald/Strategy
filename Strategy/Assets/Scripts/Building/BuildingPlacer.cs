...
public class BuildingPlacer : MonoBehaviour {
    ...
    bool CheckAllow(int xPositiont, int zPosition, Building building) {
        for (int x = 0; x < building.XSize; x++) {
            for (int z = 0; z < building.ZSize; z++) {
                Vector2Int coordinate = new Vector2Int(xPositiont + x, zPosition + z);
    ...
    void InstallBuilding(int xPositiont, int zPosition, Building building) {
        for (int x = 0; x < building.XSize; x++) {
            for (int z = 0; z < building.ZSize; z++) {
                Vector2Int coordinate = new Vector2Int(xPositiont + x, zPosition + z);
